...
print("3.", D1['names'][-1]['last_name'], D1['Salaries'][1], D1['Age'][-2])
...
print("4.", usa_states_info["states"][4]["abbreviation"], usa_states_info["states"][-5]["area_codes"][-3],end=" ")
